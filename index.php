...
<div class="cadastrar">
    ...
    <div class="resultado">
        <form action="#" method="post">
            <input type="text" maxlength="" placeholder="Insira a resposta do JOGO" required name="numerodojogo" onkeypress='return event.charCode>= 48 && event.charCode<= 57'></input>
